...
- Contexto: `popup`
- Elemento: `#binderGoToSearch` em `src/popup/popup.html:1145`
- Evento: `click`
- Handler: `(` (src/controllers/PopupController.js:318)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1145`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:318`

Trecho mínimo do binding:
```js
316: 
317:     // Binder CTA: Go to Search
318:     this.view.elements.binderGoToSearch?.addEventListener('click', () => {
319:       this.view.switchTab('search');
320:     });
```
