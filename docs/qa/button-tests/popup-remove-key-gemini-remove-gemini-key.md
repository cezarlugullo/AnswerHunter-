...
- Contexto: `popup`
- Elemento: `#remove-key-gemini` em `src/popup/popup.html:329`
- Evento: `click`
- Handler: `() => this.handleRemoveGeminiKey()` (src/controllers/PopupController.js:314)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:329`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:314`
