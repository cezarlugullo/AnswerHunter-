...
- Contexto: `popup`
- Elemento: `#clearBinderBtn` em `src/popup/popup.html:1137`
- Evento: `click`
- Handler: `() => BinderController.handleClearAll()` (src/controllers/PopupController.js:208)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1137`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:208`

Trecho mínimo do binding:
```js
206:     this.view.elements.searchBtn?.addEventListener('click', () => this.handleSearch());
207:     this.view.elements.copyBtn?.addEventListener('click', () => this.handleCopyAll());
...
| --- | --- | --- |
| happy | ✅ clique executado com mudança de estado | clicked=true; hidden=true; disabled=false; before={"ls":5,"ss":0,"status":"Testando conexão...","url":"http://127.0.0.1:4174/src/popup/popup.html"}; after={"ls":6,"ss":0,"status":"Testando conexão...","url":"http://127.0.0.1:4174/src/popup/popup.html"}; pageErrors=0 |
| empty | ✅ clique executado com mudança de estado | clicked=true; hidden=true; disabled=false; before={"ls":1,"ss":0,"status":"Testando conexão...","url":"http://127.0.0.1:4174/src/popup/popup.html"}; after={"ls":2,"ss":0,"status":"Testando conexão...","url":"http://127.0.0.1:4174/src/popup/popup.html"}; pageErrors=0 |
