...
- Contexto: `popup`
- Elemento: `#btnAddDiscNew` em `src/popup/popup.html:1163`
- Evento: `click`
- Handler: `() => this._toggleCreateForm(true)` (src/controllers/DisciplinasController.js:13)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1163`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\DisciplinasController.js:13`
