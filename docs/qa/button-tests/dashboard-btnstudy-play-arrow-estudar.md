...
- Contexto: `dashboard`
- Elemento: `#btnStudy` em `src/dashboard/discipline-detail.html:133`
- Evento: `click`
- Handler: `(` (src/dashboard/discipline-detail.html:275)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\discipline-detail.html:133`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\discipline-detail.html:275`

Trecho mínimo do binding:
```js
273: 
274:     function bindEvents() {
275:       document.getElementById('btnStudy')?.addEventListener('click', () => {
276:         const url = chrome.runtime.getURL(`src/study/study.html?discipline=${encodeURIComponent(discipline.name)}`);
277:         chrome.tabs.create({ url });
```
