...
- Contexto: `popup`
- Elemento: `#geminiAuthBtn` em `src/popup/popup.html:483`
- Evento: `click`
- Handler: `() => this.openGeminiAuthPanel()` (src/controllers/PopupController.js:184)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:483`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:184`

Trecho mínimo do binding:
```js
182: 
183:     // Gemini (Google) Auth buttons
184:     document.getElementById('geminiAuthBtn')?.addEventListener('click', () => this.openGeminiAuthPanel());
185:     document.getElementById('gemini-auth-close')?.addEventListener('click', () => {
