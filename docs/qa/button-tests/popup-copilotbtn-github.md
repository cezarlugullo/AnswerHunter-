...
- Contexto: `popup`
- Elemento: `#copilotBtn` em `src/popup/popup.html:496`
- Evento: `click`
- Handler: `(` (src/controllers/PopupController.js:193)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:496`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:193`

Trecho mínimo do binding:
```js
191: 
192:     // Copilot (GitHub) Auth buttons
193:     document.getElementById('copilotBtn')?.addEventListener('click', () => {
194:       document.getElementById('copilot-auth-section')?.classList.remove('hidden');
195:     });
```
