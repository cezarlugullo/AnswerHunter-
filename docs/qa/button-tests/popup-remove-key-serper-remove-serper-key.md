...
- Contexto: `popup`
- Elemento: `#remove-key-serper` em `src/popup/popup.html:256`
- Evento: `click`
- Handler: `() => this.handleRemoveSerperKey()` (src/controllers/PopupController.js:313)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:256`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:313`
