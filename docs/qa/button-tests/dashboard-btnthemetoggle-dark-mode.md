...
- Contexto: `dashboard`
- Elemento: `#btnThemeToggle` em `src/dashboard/dashboard-v2.html:285`
- Evento: `click`
- Handler: `(` (src/dashboard/dashboard-v2.js:548)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.html:285`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.js:548`

Trecho mínimo do binding:
```js
546: function bindEvents() {
547:   // Theme toggle
548:   document.getElementById('btnThemeToggle')?.addEventListener('click', () => {
549:     const current = document.documentElement.getAttribute('data-theme');
550:     const next = current === 'dark' ? '' : 'dark';
```
...
| missing_permissions | ⚠️ clique executado sem mudança observável | clicked=true; hidden=true; disabled=false; before={"ls":1,"ss":1,"status":"","url":"http://127.0.0.1:4174/src/dashboard/dashboard-v2.html"}; after={"ls":1,"ss":1,"status":"","url":"http://127.0.0.1:4174/src/dashboard/dashboard-v2.html"}; pageErrors=1 |
