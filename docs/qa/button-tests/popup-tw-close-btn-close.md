...
- Contexto: `popup`
- Elemento: `#tw-close-btn` em `src/popup/popup.html:1298`
- Evento: `click`
- Handler: `() => this._closeTurboWizard()` (src/controllers/PopupController.js:5050)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1298`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:5050`

Trecho mínimo do binding:
```js
5048:       overlay._wizardBound = true;
5049: 
