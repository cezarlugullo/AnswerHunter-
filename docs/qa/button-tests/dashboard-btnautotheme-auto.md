...
- Contexto: `dashboard`
- Elemento: `#btnAutoTheme` em `src/dashboard/dashboard-v2.html:457`
- Evento: `click`
- Handler: `(` (src/dashboard/dashboard-v2.js:564)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.html:457`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.js:564`

Trecho mínimo do binding:
```js
562:     if (!DEMO) chrome.storage.local.set({ ah_theme: 'dark' });
563:   });
564:   document.getElementById('btnAutoTheme')?.addEventListener('click', () => {
565:     document.documentElement.removeAttribute('data-theme');
566:     if (!DEMO) chrome.storage.local.set({ ah_theme: 'auto' });
```
