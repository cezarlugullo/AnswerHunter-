...
- Contexto: `dashboard`
- Elemento: `#btnMigrate` em `src/dashboard/dashboard-v2.html:446`
- Evento: `click`
- Handler: `async (` (src/dashboard/dashboard-v2.js:584)
- Use-case/service: MigrationService
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.html:446`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\dashboard\dashboard-v2.js:584`

Trecho mínimo do binding:
```js
582: 
583:   // Migrate button
584:   document.getElementById('btnMigrate')?.addEventListener('click', async () => {
585:     if (DEMO) {
586:       showToast('Migração não disponível em modo demo', { type: 'warning' });
```
