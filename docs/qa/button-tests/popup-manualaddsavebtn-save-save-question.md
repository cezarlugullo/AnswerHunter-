...
- Contexto: `popup`
- Elemento: `#manualAddSaveBtn` em `src/popup/popup.html:1276`
- Evento: `click`
- Handler: `() => this._submitManualAdd()` (src/controllers/BinderController.js:552)
- Use-case/service: BinderController, StorageModel
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1276`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\BinderController.js:552`

Trecho mínimo do binding:
```js
550:             });
551: 
552:             document.getElementById('manualAddSaveBtn')?.addEventListener('click', () => this._submitManualAdd());
553: 
