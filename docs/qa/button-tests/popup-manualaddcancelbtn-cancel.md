...
- Contexto: `popup`
- Elemento: `#manualAddCancelBtn` em `src/popup/popup.html:1275`
- Evento: `click`
- Handler: `() => this._closeManualAddModal()` (src/controllers/BinderController.js:539)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1275`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\BinderController.js:539`
...
540:             overlay.addEventListener('click', (e) => { if (e.target === overlay) this._closeManualAddModal(); });
541: 
```
