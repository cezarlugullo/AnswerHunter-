# content_copy Copy all

- Contexto: `popup`
- Elemento: `#copyBtn` em `src/popup/popup.html:1106`
- Evento: `click`
- Handler: `() => this.handleCopyAll()` (src/controllers/PopupController.js:207)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1106`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\PopupController.js:207`

Trecho mínimo do binding:
```js
205:     this.view.elements.extractBtn?.addEventListener('click', () => this.handleExtract());
