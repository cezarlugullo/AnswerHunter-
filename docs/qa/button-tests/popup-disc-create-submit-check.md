...
- Contexto: `popup`
- Elemento: `#disc-create-submit` em `src/popup/popup.html:1171`
- Evento: `click`
- Handler: `() => this._handleCreate()` (src/controllers/DisciplinasController.js:15)
...
Arquivo DOM: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\popup\popup.html:1171`
Arquivo handler: `C:\Users\cezar\OneDrive\Área de Trabalho\AnswerHunter\src\controllers\DisciplinasController.js:15`
...
17:             if (e.key === 'Enter') this._handleCreate();
```
