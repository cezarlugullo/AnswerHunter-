...
> Equivalente ao plugin `frontend-design@claude-code-plugins`

Create distinctive, production-grade frontend interfaces with high design quality.
Use this when asked to build web components, pages, or applications.
Generates creative, polished code that avoids generic AI aesthetics.

---

This guides creation of distinctive, production-grade frontend interfaces
