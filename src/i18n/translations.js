...
export const TRANSLATIONS = {
  en: {
    ...
    'binder.moveToParent': 'Move to parent folder',
    ...
    'setup.groq.tagline': 'Groq is <strong>required</strong> — it\'s the AI brain that analyzes your questions. Without it, the extension won\'t work.',
    ...
    'setup.serper.tagline': 'Serper is <strong>required</strong> — without it, web evidence search won\'t work.',
    ...
    'setup.gemini.tagline': 'Gemini is <strong>optional</strong> — acts as a smart backup when Groq hits its limit. Recommended.',
  ...
  'pt-BR': {
    ...
    'binder.moveToParent': 'Mover para pasta acima',
    ...
    'setup.groq.tagline': 'Groq é <strong>obrigatório</strong> — é o cérebro de IA que analisa suas questões. Sem ele, a extensão não funciona.',
    ...
    'setup.serper.tagline': 'Serper é <strong>obrigatório</strong> — sem ele a busca por evidências na web não funciona.',
    ...
    'setup.gemini.tagline': 'Gemini é <strong>opcional</strong> — entra como backup inteligente quando o Groq atingir o limite. Recomendado ter.',
