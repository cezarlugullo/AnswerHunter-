...
export const TRANSLATIONS = {
  ...
  'pt-BR': {
    ...
    'setup.nextHelp': 'Quando a validação for aprovada, o botão Próximo será liberado automaticamente.',
    'setup.groq.title': 'Configurar chave Groq',
    'setup.groq.tagline': 'Groq é obrigatório. Ele ajuda a extensão a entender e analisar cada questão.',
    'setup.groq.step1': 'Clique em \"Abrir site oficial\" e crie sua conta grátis na Groq.',
    'setup.groq.step2': 'Na Groq, abra \"API Keys\" e crie uma nova chave.',
    'setup.groq.step3': 'Copie a chave, cole abaixo e clique em \"Validar chave\".',
    'setup.hint.groq': 'Chaves Groq começam com \"gsk_\".',
    'setup.serper.title': 'Configurar chave Serper',
    'setup.serper.tagline': 'Serper é opcional. Ele melhora cobertura de evidências e qualidade do ranqueamento.',
    'setup.serper.step1': 'Clique em \"Abrir site oficial\" e crie sua conta grátis na Serper.',
    'setup.serper.step2': 'Abra seu dashboard e localize sua API Key.',
    'setup.serper.step3': 'Copie a chave, cole abaixo e clique em \"Validar chave\".',
    'setup.hint.serper': 'Copie a chave longa exibida no dashboard da Serper.',
    'setup.searchProvider.label': 'Provedor de busca',
    'setup.searchProvider.serper': 'Serper (plano grátis)',
    'setup.searchProvider.serpapi': 'SerpApi (melhor cobertura de AI Overview)',
    'setup.searchProvider.hint': 'Escolha o provedor. SerpApi costuma retornar AI Overview com mais frequência.',
    'setup.gemini.title': 'Opcional: configurar backup Gemini',
    'setup.gemini.tagline': 'Etapa opcional. Gemini só entra quando Groq estiver indisponível.',
    'setup.gemini.step1': 'Clique em \"Abrir site oficial\" e entre no Google AI Studio.',
    'setup.gemini.step2': 'Clique em \"Get API key\" e depois em \"Create API key\".',
    'setup.gemini.step3': 'Copie a chave, cole abaixo e valide se quiser backup de IA.',
    'setup.hint.gemini': 'Chaves Gemini começam com \"AIza\".',
    'setup.gemini.hint': 'Você pode pular esta etapa e finalizar agora.',
    'setup.gemini.finishHelp': 'Gemini é opcional. Você pode validar agora ou pular e finalizar.',
    'setup.aiConfig.title': 'Provedor e Modelos de IA',
    'setup.aiConfig.primaryLabel': 'Provedor principal de IA',
    'setup.aiConfig.fast': 'Rápido',
    'setup.aiConfig.smart': 'Inteligente',
    'setup.aiConfig.hintGroqPrimary': 'Groq roda primeiro (rápido). Gemini entra se Groq estiver ocupado.',
    'setup.aiConfig.hintGeminiPrimary': 'Gemini roda primeiro (mais inteligente). Groq entra se Gemini estiver ocupado.',
